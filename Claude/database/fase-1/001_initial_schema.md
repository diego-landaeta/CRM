...
- **Comando:** `PGPASSWORD="CrmDB2026!Secure" psql -h localhost -U crm_user -d crm_test_db -f /tmp/001_initial_schema.sql`
...
- **Comando:** `PGPASSWORD="CrmDB2026!Secure" psql -h localhost -U crm_user -d crm_db -f /tmp/001_initial_schema.sql`
- **Resultado:** OK - 14 tablas, 7 enums, 9 indices
...
- Password temporal de los 3 usuarios: `CrmTemp2026!` (bcrypt cost 12)
