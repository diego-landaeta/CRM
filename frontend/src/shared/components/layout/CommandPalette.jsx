...
const SECTIONS = [
  ...
  { label: 'Prospectos', to: '/leads', icon: Users, keywords: 'leads contactos' },
  { label: 'Pipeline', to: '/leads/pipeline', icon: Users, keywords: 'kanban embudo' },
  { label: 'Audiencias', to: '/leads/audiences', icon: Export, keywords: 'segmentos exportar' },
  { label: 'Clientes', to: '/clients', icon: UserCheck, keywords: 'cuentas convertidos' },
  { label: 'Matrículas', to: '/matriculas', icon: UserCheck, keywords: 'inscripciones' },
  { label: 'Productos', to: '/products', icon: Package, keywords: 'catalogo' },
  ...
  { label: 'Formularios', to: '/forms', icon: Globe, keywords: 'captura webhook' },
  { label: 'Webhooks', to: '/webhooks', icon: Globe, keywords: 'integraciones api' },
  { label: 'Campañas — Consolidado', to: '/campaigns', icon: Megaphone, keywords: 'ads' },
  { label: 'Campañas — Meta Ads', to: '/campaigns/meta', icon: FacebookLogo, keywords: 'facebook instagram' },
  { label: 'Campañas — Google Ads', to: '/campaigns/google', icon: GoogleLogo, keywords: 'adwords' },
  { label: 'Tráfico orgánico (SEO)', to: '/seo', icon: MagnifyingGlass, keywords: 'organic search console' },
...
export default function CommandPalette() {
  ...
  const quickActions = useMemo(() => [
    { id: 'qa-new-lead', label: 'Crear nuevo prospecto', icon: Plus, keywords: 'nuevo lead crear contacto', run: () => navigate('/leads?new=1') },
