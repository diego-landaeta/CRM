...
export default function ClientsPage() {
  ...
  }, [activeProject?.id, isAllProjects, projects, page, debouncedSearch, filterResp, filterProducto, dateFrom, dateTo, reloadKey]);
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            {filtered.length > 0 && (
              <button
                ...
                title="Exportar CSV"
                className="h-9 px-3 rounded-md border border-border bg-muted/50 hover:bg-muted text-muted-foreground hover:text-foreground flex items-center gap-1.5 text-xs font-medium"
              >
