...
function fmt(n) {
  // Con los centimos SIEMPRE. Esto son euros que alguien pago o que alguien
  // debe, no una cifra de resumen: redondeando, una venta de 1.793,36 aparecia
  // como 1.793 y una cuota de 896,68 como 897, que no es lo que dice la factura.
...
export default function ClientDetailPage() {
  ...
  // El chat se abre DENTRO del CRM. Antes este boton lanzaba wa.me en otra
  // pestaña: se salia del CRM, no quedaba registro de que se habia escrito, y
  // con varias sesiones enlazadas abria la del navegador —que puede ser la
  // personal de quien pulsa— en vez de la del CRM.
  ...
  // Limpiamos el cliente anterior al cambiar de id (no mostrar datos de otra ficha
