  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-zinc-500 text-sm">Conversiones, pagos y evolucion &mdash; {activeProject.nombre}</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-[0_1px_2px_0_rgb(0_0_0/0.05)]">
          ...
          <p className="text-zinc-400 text-[11px] font-bold uppercase tracking-wider">Ingresos Mes</p>
        ...
        <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-[0_1px_2px_0_rgb(0_0_0/0.05)]">
          ...
          <p className="text-zinc-400 text-[11px] font-bold uppercase tracking-wider">Conversiones Mes</p>
        ...
        <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-[0_1px_2px_0_rgb(0_0_0/0.05)]">
          ...
          <p className="text-zinc-400 text-[11px] font-bold uppercase tracking-wider">Ticket Medio</p>
        ...
        <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-[0_1px_2px_0_rgb(0_0_0/0.05)]">
          ...
          <p className="text-zinc-400 text-[11px] font-bold uppercase tracking-wider">CPL Medio</p>
      ...
      <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-[0_1px_2px_0_rgb(0_0_0/0.05)]">
        <div className="mb-6">
          ...
          <p className="text-[11px] text-zinc-400 mt-0.5">Ultimos 6 meses</p>
        </div>
      ...
      <div className="bg-white rounded-3xl border border-zinc-100 shadow-[0_1px_2px_0_rgb(0_0_0/0.05)] overflow-hidden">
        <div className="p-5">
          ...
          <p className="text-[11px] text-zinc-400 mt-0.5">Ultimos pagos registrados</p>
        </div>
        {conversions.length === 0 ? (
          <div className="px-5 py-12 text-center text-zinc-400">No hay conversiones para este proyecto aun.</div>
        ) : (
          <table className="w-full text-[13px]">
            <thead className="bg-zinc-50/80 border-y">
              <tr>
                <th className="px-5 py-2.5 text-left text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Lead</th>
                <th className="px-5 py-2.5 text-left text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Producto</th>
                <th className="px-5 py-2.5 text-left text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Monto</th>
                <th className="px-5 py-2.5 text-left text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Tipo</th>
                <th className="px-5 py-2.5 text-left text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Fecha</th>
              </tr>
            </thead>
            <tbody>
              {conversions.map((c) => (
                <tr key={c.id} className="border-b last:border-0 hover:bg-zinc-50/50 transition-colors">
                  <td className="px-5 py-3 font-semibold">{c.lead}</td>
                  <td className="px-5 py-3 text-zinc-500">{c.producto}</td>
                  ...
                  <td className="px-5 py-3 text-zinc-400">{c.fecha}</td>
                </tr>
              ))}
            </tbody>
          </table>
