  ...
  return (
    ...
    >
      ...
      {open && (
        <span
          role="tooltip"
          className="absolute z-[60] left-0 top-full mt-1.5 w-72 max-w-[calc(100vw-1.5rem)] p-3 rounded-md bg-foreground text-background shadow-2xl text-[11px] leading-snug normal-case font-normal pointer-events-none"
