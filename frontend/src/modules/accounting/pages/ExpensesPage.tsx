...
import { EXPENSE_CATEGORY_COLORS } from '@/shared/lib/ui';

const ConfirmDialog = lazy(() => import('@/shared/components/ui/ConfirmDialog'));

const ALL_CATEGORIAS = [...MANUAL_CATEGORIES, ...AUTO_CATEGORIES];
// Los colores de una categoría de gasto son IDENTIDAD, no semántica: sirven
// para distinguir alquiler de salarios, no para decir si un gasto es bueno.
// Viven en `shared/lib/ui` con las demás paletas de identidad, y hay una prueba
// que exige que sigan siendo todos distintos.
const CAT_COLORS: Record<string, string> = EXPENSE_CATEGORY_COLORS;
                  ...
                  <tr key={e.id} className="border-b last:border-0 hover:bg-muted/30">
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        ...
                        {isAutoGenerated(e) && (
                          <span title="Generado automáticamente por el sistema" className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-[9px] font-bold bg-primary/10 text-primary">
                    ...
                    <td className="px-5 py-3 text-right">
                      <div className="inline-flex gap-1">
                        ...
                        <button
                          ...
                          className="h-8 w-8 inline-flex items-center justify-center rounded hover:bg-destructive-soft text-muted-foreground hover:text-destructive focus:outline-none focus:ring-2 focus:ring-primary/40 disabled:opacity-30 disabled:cursor-not-allowed"
                        >
              ...
              <div key={e.id} className="bg-card border border-border rounded-lg p-3 flex items-start gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 mb-1 flex-wrap">
                    ...
                    {isAutoGenerated(e) && (
                      <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-[9px] font-bold bg-primary/10 text-primary">
                        <Lightning size={9} weight="fill" /> auto
                      </span>
                    )}
                    {e.comprobante_url && (
                ...
                <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button
                      ...
                      aria-label="Eliminar egreso"
                      disabled={isAutoGenerated(e)}
                      className="h-7 w-7 inline-flex items-center justify-center rounded hover:bg-destructive-soft text-muted-foreground hover:text-destructive disabled:opacity-30"
                    >
              ...
              {form.comprobante_url ? (
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-border bg-muted/30 text-xs">
                  ...
                  <button type="button" onClick={removeComprobante}
                    className="h-7 w-7 inline-flex items-center justify-center rounded hover:bg-muted text-muted-foreground hover:text-destructive">
