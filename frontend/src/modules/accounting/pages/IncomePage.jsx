    ...
    <div className="space-y-5 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-2xl p-4">
          <p className="text-[11px] font-bold uppercase text-muted-foreground mb-1">Ventas</p>
          <p className="text-2xl font-extrabold">{items.length}</p>
        </div>
        <div className="bg-card border border-border rounded-2xl p-4">
          <p className="text-[11px] font-bold uppercase text-muted-foreground mb-1">Facturado</p>
          <p className="text-2xl font-extrabold">{fmt(totalFacturado)}</p>
        </div>
        <div className="bg-card border border-border rounded-2xl p-4">
          <p className="text-[11px] font-bold uppercase text-muted-foreground mb-1">Cobrado</p>
