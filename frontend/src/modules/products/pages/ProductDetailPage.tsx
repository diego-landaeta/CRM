  ...
  return (
    <div className="p-5 max-w-4xl mx-auto space-y-5 pb-12">
      ...
      {/* CONVOCATORIA · plazas y cierre (#86)
          Va en su propio bloque y no como una pastilla mas porque es el dato que
          la gestora tiene que mirar ANTES de cada envio: el proceso comercial lo
          pide en cuatro de sus cinco pasos y prohibe expresamente arrastrar el
