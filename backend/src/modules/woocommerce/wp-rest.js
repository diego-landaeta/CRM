...
// Para sacar ACF, CPTs custom y taxonomías custom desde sitios WP.
// ============================================================
...
export async function fetchCptAll(baseUrl, cptSlug, user, pass, opts = {}) {
  ...
  for (let page = 1; page <= maxPages; page++) {
    ...
    try {
      ...
      logger.warn({ cptSlug, page, err: err.message }, 'WP REST: error trayendo página');
      break;
    }
  }
  return all;
...
/** Resuelve un término de taxonomía custom (devuelve {name, slug, parent}). */
 ...
 * Estrategia: si los ACF están presentes, usarlos directo. Si no, fallback.
 */
