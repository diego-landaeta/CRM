...
export async function listCampaignsForUI({ projectId, accountId = null, status = null, dateFrom = null, dateTo = null }) {
  ...
  // identificador de campaña en `lead_utms.utm_campaign`. Cruzado, salen 129
  // leads y 10 ventas que hoy no se ven en ninguna pantalla (comprobado contra
  // produccion el 14/09) — con «VENTAS - Cursos destacados» en 31 donde Meta
  // dice 0.
  //
  // Va en un LATERAL y con DISTINCT a proposito: un lead puede tener varias
  // filas de UTM, y un JOIN a secas multiplicaria el gasto de la campaña por
  // cada una. Ya nos paso contando ventas por campus.
