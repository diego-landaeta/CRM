...
-- Extiende project_field_definitions y anade custom_fields a clients y products
-- ============================================================

BEGIN;

-- 1) entidad sobre la que aplica el campo (lead, client, product)
...
-- 2) cambiar UNIQUE para incluir entity
...
-- 3) indice para listados rapidos por entidad
...
-- 4) custom_fields JSONB en clients y products (solo si las tablas existen)
DO $$
BEGIN
