-- ============================================================
-- 038: Audit log de documentos (factura/certificado)
-- ============================================================
-- Trazabilidad fiscal: registra quien generó/descargó/regeneró/eliminó cada
-- documento y desde donde. Cumple requisito de auditoria para Hacienda.
