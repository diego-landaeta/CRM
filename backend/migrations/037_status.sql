-- ============================================================
-- Migración 037: Página de status del sistema
-- ============================================================
...
ALTER TABLE status_components OWNER TO crm_user;
ALTER TABLE status_incidents OWNER TO crm_user;
ALTER TABLE status_errors OWNER TO crm_user;
ALTER SEQUENCE status_components_id_seq OWNER TO crm_user;
ALTER SEQUENCE status_incidents_id_seq OWNER TO crm_user;
ALTER SEQUENCE status_errors_id_seq OWNER TO crm_user;
